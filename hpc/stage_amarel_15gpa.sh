...
TAG=bench/carbon-15gpa-20260610
DEST=/scratch/lz432/pallas_15gpa
...
scp benchmarks/carbon/run_carbon_15gpa.py hpc/submit_carbon_15gpa.sh an:$DEST/workdir_carbon/
