#!/usr/bin/env python3
"""Full pipeline: FP-drag+dimer multi-probe + barrier refinement + validation."""
import os, sys, time
...
print("=" * 60)
print("Full Pipeline: FP-drag+dimer, multi-probe, refinement")
print("CdSe RS -> WZ (8 atoms, MatterSim)")
print("=" * 60)
...
# Phase 1: Multi-probe search (FP-drag + dimer)
print("\n>>> PHASE 1: Multi-probe FP-drag+dimer search")
