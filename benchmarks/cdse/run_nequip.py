#!/usr/bin/env python3
"""Benchmark: CdSe RS->WZ with NequIP dual model (no-drag, tag-pinned)."""
import json
import random
...
with open('config.json', 'w') as f:
    json.dump({'seed': SEED, 'commit': 'v1-main', 'calc': 'nequip-dual',
               **{k: getattr(config, k) for k in config.__dataclass_fields__}}, f, indent=1)
