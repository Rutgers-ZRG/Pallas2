...
| C graphite→HD (16 at) | **15 (true)** | Allegro r2SCAN | **2.949 eV (0.184 eV/atom)**, job 5754906 | running (job 5755060) | First physically meaningful pressurized result. Path: gra (120.8 Å³) → S (109.9 Å³) → HD (87.1 Å³); reverse barrier 5.16 eV; HD −2.21 eV below gra at 15 GPa ✓ |
...
| PALLAS carbon 15 GPa (5 probes, gen-converged) | n/a (counter TODO) | — |
| G-SSNEB carbon 15 GPa | — | running |
